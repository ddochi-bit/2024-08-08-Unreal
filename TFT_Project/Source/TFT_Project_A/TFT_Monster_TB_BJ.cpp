...
ATFT_Monster_TB_BJ::ATFT_Monster_TB_BJ()
{
...
void ATFT_Monster_TB_BJ::PostInitializeComponents()
{
    ...
    if (_animInstance_Boss->IsValidLowLevel())
    {
        ...
        _animInstance_Boss->_attackStartDelegate.AddUObject(this, &ATFT_Monster_TB_BJ::AttackStart);
        _animInstance_Boss->_attackHitDelegate.AddUObject(this, &ATFT_Monster_TB_BJ::AttackHit_Boss);
        _animInstance_Boss->_deathStartDelegate.AddUObject(this, &ATFT_Monster_TB_BJ::DeathStart);
        _animInstance_Boss->_bossDeathEndDelegate.AddUObject(this, &ATFT_Monster_TB_BJ::Boss_DeathEnd);
        _animInstance_Boss->_deathEndDelegate.AddUObject(this, &ATFT_Monster_TB_BJ::BossDisable);
    }
...
void ATFT_Monster_TB_BJ::BeginPlay()
{
    Super::BeginPlay();
...
void ATFT_Monster_TB_BJ::Tick(float DeltaTime)
{
...
void ATFT_Monster_TB_BJ::SetMesh(FString path)
{
    _meshCom->SetMesh(path);
}

void ATFT_Monster_TB_BJ::Attack_AI()
{
    Super::Attack_AI();
...
void ATFT_Monster_TB_BJ::AttackStart()
{
    Super::AttackStart();
...
void ATFT_Monster_TB_BJ::AttackHit_Boss()
{
...
void ATFT_Monster_TB_BJ::DropItem()
{
    Super::DropItem();
}

void ATFT_Monster_TB_BJ::DeathStart()
{
    Super::DeathStart();
...
void ATFT_Monster_TB_BJ::Boss_DeathEnd()
{
...
void ATFT_Monster_TB_BJ::BossDisable()
{
...
void ATFT_Monster_TB_BJ::UpdateBlackboardTarget()
{
...
float ATFT_Monster_TB_BJ::TakeDamage(float DamageAmount, FDamageEvent const& DamageEvent, AController* EventInstigator, AActor* DamageCauser)
{
